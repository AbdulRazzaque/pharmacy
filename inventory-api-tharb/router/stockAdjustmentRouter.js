...
router.get('/getAdjustmentDocuments', isUserAuth, stockAdjustmentController.getAdjustmentDocuments);
router.post('/createAdjustmentDocument', isUserAuth, stockAdjustmentController.createAdjustmentDocument);
router.post('/updateAdjustmentDocument', isUserAuth, stockAdjustmentController.updateAdjustmentDocument);
